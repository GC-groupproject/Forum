...
<form enctype="multipart/form-data" id="signup" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
    ...
    <input type="text" name="firstname" <?php if(isset($_POST['firstname'])){ echo 'value="' . $_POST['firstname'] . '"';} ?> required="required"><br>
    <label for="lastname">Last name:</label>
    <input type="text" name="lastname" <?php if(isset($_POST['lastname'])){ echo 'value="' . $_POST['lastname'] . '"';} ?> required="required"><br>
    <label for="birthdate">Birthdate:</label>
    <input type="date" name="birthdate" placeholder="(YYYY/MM/DD)" required="required" <?php if(isset($_POST['birthdate'])){ echo 'value="' . $_POST['birthdate'] . '"';} ?>><br> 
	...
	<input type="password" autocomplete="on" name="password" <?php if(isset($_POST['password'])){ echo 'value="' . $_POST['password'] . '"';} ?> required="required"><br>
    <label for="password">Re-enter Password:</label>
    <input type="password" name="confirm_password" <?php if(isset($_POST['confirm_password'])){ echo 'value="' . $_POST['confirm_password'] . '"';} ?> required="required"><br>
    <img src="DATA/UserImages/anon.png" />
    <label for="photo">Upload a photo:</label>
    <input type="file" accept="image/*" <?php if(isset($_POST['image'])){ echo 'value="' . $_POST['image'] . '"';} ?> name="photo"/><br>
    <label for="country"><p class="required">*</p>Select Country</label>
    <?php if(isset($_POST['country'])){$country = $_POST['country'];} ?>
