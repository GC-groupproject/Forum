<?php session_start();
/**
	*	The website header including the doctype, header, and the session of the user.
	*	
	*/
?>
<!DOCTYPE html>
<html>
    ...
    <script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
        <!-- This website was Designed, developed, and coded by Jean-Luc Desroches, Alex Barbosa,and Durwin Barcenas -->
        <?php 
